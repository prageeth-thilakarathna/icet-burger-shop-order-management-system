...
public class DeliveredOrders extends JFrame {
    ...
    private final JTable tblDeliveredOrders;
    ...
    public DeliveredOrders() {
        setSize(1100, 640); 
        setTitle("Burger Shop - Delivered Orders");
        ...
        // label
        label = new JLabel("Delivered Orders", SwingConstants.CENTER);
        ...
        tblDeliveredOrders = new JTable(dtm);
        tblDeliveredOrders.setFont(new Font("", 1, 16));
        tblDeliveredOrders.setForeground(OrderController.typography);
        tblDeliveredOrders.setRowHeight(32);
        tblDeliveredOrders.setBackground(OrderController.whiteBack);
        tblDeliveredOrders.getTableHeader().setBackground(OrderController.headerColor);
        tblDeliveredOrders.getTableHeader().setForeground(OrderController.typography);
        tblDeliveredOrders.getTableHeader().setFont(new Font("", 1, 16));
        tblDeliveredOrders.getTableHeader().setPreferredSize(new Dimension(50, 50));

        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment(JLabel.CENTER);

        tblDeliveredOrders.getColumnModel().getColumn(0).setCellRenderer(centerRenderer); // cell value center
        tblDeliveredOrders.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
        tblDeliveredOrders.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
        tblDeliveredOrders.getColumnModel().getColumn(3).setCellRenderer(centerRenderer);
        tblDeliveredOrders.getColumnModel().getColumn(4).setCellRenderer(centerRenderer);

        // scroll 
        JScrollPane sp = new JScrollPane(tblDeliveredOrders);
